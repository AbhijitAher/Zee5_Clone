function navbar(){
    ...
    <div class="container inline-flex mr-10 pl-7 items-center w-10/12">
        ...
        <a class="px-3 text-sm"  href="index.html">
            <p class="text-sm whitespace-nowrap p-1 border-black border-b-2 transition duration-250 ease-in hover:border-white">Home</p>
        </a>
        <a class="px-3" href="#">
        ...
        <a class="px-3" href="movies.html">
            <p class="border-b-2 border-white p-1">Movies</p>
        </a>
        <a class="px-3" href="#">
